::
:: Batch script to transform ground points (classified as 2) from las file to a comma separated ASCII xyz file (e.g. for Civil3D)
::
:: Input is LAS file
...
set INFILE=%1
set OUTFILE=%INFILE:~0,-4%_ground_points.txt
